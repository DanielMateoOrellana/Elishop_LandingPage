...
export default function Contact() {
    ...
    const [gridRef, visibleItems] = useStaggeredAnimation(3, 150);
        ...
        <section className="contact" id="contact">
            <div className="container">
                ...
                <div className="contact-grid" ref={gridRef}>
                    <div className={`contact-card animate-fade-in-up ${visibleItems.includes(0) ? 'visible' : ''}`}>
                    ...
                    <div className={`contact-card animate-fade-in-up ${visibleItems.includes(1) ? 'visible' : ''}`}>
                    ...
                    <div className={`contact-card animate-fade-in-up ${visibleItems.includes(2) ? 'visible' : ''}`}>
